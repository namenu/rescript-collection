...
Zora.test("emptyness", (async function (t) {
        t.test("remove", (async function (t) {
                t.is(Deque.empty, Deque.popFront(Deque.empty), "");
                t.is(Deque.empty, Deque.popBack(Deque.empty), "");
              }));
        t.test("get", (async function (t) {
...
Zora.test("toArray", (async function (t) {
...
Zora.test("adventofcode 2018-9", (async function (t) {
